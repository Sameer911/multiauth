...
@section('content')
    ...
    <!-- Save--Modal -->
<div class="modal fade" id="ModalSave" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <table class="table myTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" value="{{$item->id}}" class="btn btn-success btnsave btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            Pay Order
                          </button>
                    </td>
    ...
    <script>
        ...
        function getMedia() {
            return new Promise((resolve, reject) => {
                ...
                .then(str => {
                    resolve(str);
                    $('#remote-media').html('<video id="basic-stream" width="100%" class="hidden videostream" autoplay=""></video>');
                }).catch(err => {
